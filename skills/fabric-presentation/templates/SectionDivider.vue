<script setup lang="ts">
  /*
   * Template case: section-divider (tpl-02, exm-03; example deck slides 05,
   * 09 and 14).
   *
   ...
   * `class: fx-section-slide`; deck-style.css §4 is the rule that class needs.
   * Without a positioned ancestor the absolute boxes resolve against the
   * window.
   *
...
<style scoped>
  /* Every value comes from ../assets/fabric-tokens.css, which the deck copies
     to its own root. The gradient pair is the one ground the law allows a
     gradient on. */
